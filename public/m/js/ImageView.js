...
var ImageView=(function(window,$){
    ...
    var Event={
        ...
        setView:function(e){
            ...
            translate((-_index*window.innerWidth-0),0,0,$(".pv-inner")[0]);
            scaleDown(getImg())
        }
    ...
    var scaleUp=function(img) {
        var scale = getScale(img)<2?2:getScale(img);
    ...
    var changeIndex=function(index,force){
        ...
        _index = index;
        translate((-_index*window.innerWidth-0),0,force? "0" : "200" ,$(".pv-inner")[0]);
     ...
     */
    var Create=function(){
    	if($(".slide-bg")!=null&&typeof($(".slide-bg"))!="undefined"){
    		$(".slide-bg").remove();
    		$(".pv-inner").remove();
    		$(".counts").remove();
    		$(".ui-loading").remove();
        ...
        _this.append("<div class='slide-bg'></div><ul class='pv-inner'></ul>").append("<p class='counts'><span class='value' id='J_index'>"+(_index+1)+"/"+_length+"</span></p>").append("<span class='ui-loading' id='J_loading' ><i class='t1'></i><i class='t2'></i><i class='t3'></i></span>");
